-- File BLUEPRINT-data_model-0.2.99.6.1-20130814_CVtrans.sql
-- Generated from BLUEPRINT 0.2.99.6.1
-- Wed Aug 14 17:04:52 2013
...
UPDATE sdata_specimen , anon_344532480_CVkeys , anon_344532480_CV
SET
	sdata_specimen.specimen_type_term = anon_344532480_CV.descr
WHERE
	sdata_specimen.specimen_type_term IS NULL AND
	sdata_specimen.specimen_type = anon_344532480_CVkeys.cvkey
	AND anon_344532480_CVkeys.idkey = anon_344532480_CV.idkey
;
ALTER TABLE sdata_specimen ADD COLUMN specimen_processing_term VARCHAR(1024);

UPDATE sdata_specimen , anon_345311664_CVkeys , anon_345311664_CV
SET
	sdata_specimen.specimen_processing_term = anon_345311664_CV.descr
WHERE
	sdata_specimen.specimen_processing_term IS NULL AND
	sdata_specimen.specimen_processing = anon_345311664_CVkeys.cvkey
	AND anon_345311664_CVkeys.idkey = anon_345311664_CV.idkey
;
ALTER TABLE sdata_specimen ADD COLUMN specimen_storage_term VARCHAR(1024);

UPDATE sdata_specimen , anon_345352032_CVkeys , anon_345352032_CV
SET
	sdata_specimen.specimen_storage_term = anon_345352032_CV.descr
WHERE
	sdata_specimen.specimen_storage_term IS NULL AND
	sdata_specimen.specimen_storage = anon_345352032_CVkeys.cvkey
	AND anon_345352032_CVkeys.idkey = anon_345352032_CV.idkey
;
...
UPDATE sdata_sample , anon_345365976_CVkeys , anon_345365976_CV
SET
	sdata_sample.analyzed_sample_type_term = anon_345365976_CV.descr
WHERE
	sdata_sample.analyzed_sample_type_term IS NULL AND
	sdata_sample.analyzed_sample_type = anon_345365976_CVkeys.cvkey
	AND anon_345365976_CVkeys.idkey = anon_345365976_CV.idkey
;
...
UPDATE exp_m , anon_48928280_CVkeys , anon_48928280_CV
SET
	exp_m.data_status_term = anon_48928280_CV.descr
WHERE
	exp_m.data_status_term IS NULL AND
	exp_m.data_status = anon_48928280_CVkeys.cvkey
	AND anon_48928280_CVkeys.idkey = anon_48928280_CV.idkey
;
ALTER TABLE jcn_m ADD COLUMN data_status_term VARCHAR(1024);

UPDATE jcn_m , anon_48928280_CVkeys , anon_48928280_CV
SET
	jcn_m.data_status_term = anon_48928280_CV.descr
WHERE
	jcn_m.data_status_term IS NULL AND
	jcn_m.data_status = anon_48928280_CVkeys.cvkey
	AND anon_48928280_CVkeys.idkey = anon_48928280_CV.idkey
;
ALTER TABLE pdna_m ADD COLUMN data_status_term VARCHAR(1024);

UPDATE pdna_m , anon_48928280_CVkeys , anon_48928280_CV
SET
	pdna_m.data_status_term = anon_48928280_CV.descr
WHERE
	pdna_m.data_status_term IS NULL AND
	pdna_m.data_status = anon_48928280_CVkeys.cvkey
	AND anon_48928280_CVkeys.idkey = anon_48928280_CV.idkey
;
ALTER TABLE rreg_m ADD COLUMN data_status_term VARCHAR(1024);

UPDATE rreg_m , anon_48928280_CVkeys , anon_48928280_CV
SET
	rreg_m.data_status_term = anon_48928280_CV.descr
WHERE
	rreg_m.data_status_term IS NULL AND
	rreg_m.data_status = anon_48928280_CVkeys.cvkey
	AND anon_48928280_CVkeys.idkey = anon_48928280_CV.idkey
;
ALTER TABLE dlat_m ADD COLUMN data_status_term VARCHAR(1024);

UPDATE dlat_m , anon_48928280_CVkeys , anon_48928280_CV
SET
	dlat_m.data_status_term = anon_48928280_CV.descr
WHERE
	dlat_m.data_status_term IS NULL AND
	dlat_m.data_status = anon_48928280_CVkeys.cvkey
	AND anon_48928280_CVkeys.idkey = anon_48928280_CV.idkey
;
ALTER TABLE dlat_dm ADD COLUMN data_status_term VARCHAR(1024);

UPDATE dlat_dm , anon_48928280_CVkeys , anon_48928280_CV
SET
	dlat_dm.data_status_term = anon_48928280_CV.descr
WHERE
	dlat_dm.data_status_term IS NULL AND
	dlat_dm.data_status = anon_48928280_CVkeys.cvkey
	AND anon_48928280_CVkeys.idkey = anon_48928280_CV.idkey
;
...
UPDATE dlat_m , anon_345404472_CVkeys , anon_345404472_CV
SET
	dlat_m.mr_type_term = anon_345404472_CV.descr
WHERE
	dlat_m.mr_type_term IS NULL AND
	dlat_m.mr_type = anon_345404472_CVkeys.cvkey
	AND anon_345404472_CVkeys.idkey = anon_345404472_CV.idkey
;
ALTER TABLE dlat_n ADD COLUMN d_lation_type_term VARCHAR(1024);

UPDATE dlat_n , anon_345608592_CVkeys , anon_345608592_CV
SET
	dlat_n.d_lation_type_term = anon_345608592_CV.descr
WHERE
	dlat_n.d_lation_type_term IS NULL AND
	dlat_n.d_lation_type = anon_345608592_CVkeys.cvkey
	AND anon_345608592_CVkeys.idkey = anon_345608592_CV.idkey
;
ALTER TABLE dlat_dmr ADD COLUMN hyper_role_term VARCHAR(1024);

UPDATE dlat_dmr , anon_345624384_CVkeys , anon_345624384_CV
SET
	dlat_dmr.hyper_role_term = anon_345624384_CV.descr
WHERE
	dlat_dmr.hyper_role_term IS NULL AND
	dlat_dmr.hyper_role = anon_345624384_CVkeys.cvkey
	AND anon_345624384_CVkeys.idkey = anon_345624384_CV.idkey
;
