-- File BLUEPRINT-data_model-0.2.99.6.3-20130820_CVtrans.sql
-- Generated from BLUEPRINT 0.2.99.6.3
-- Tue Aug 20 14:20:07 2013
...
UPDATE sdata_specimen , anon_346725632_CVkeys , anon_346725632_CV
SET
	sdata_specimen.specimen_type_term = anon_346725632_CV.descr
WHERE
	sdata_specimen.specimen_type_term IS NULL AND
	sdata_specimen.specimen_type = anon_346725632_CVkeys.cvkey
	AND anon_346725632_CVkeys.idkey = anon_346725632_CV.idkey
;
ALTER TABLE sdata_specimen ADD COLUMN specimen_processing_term VARCHAR(1024);

UPDATE sdata_specimen , anon_346928288_CVkeys , anon_346928288_CV
SET
	sdata_specimen.specimen_processing_term = anon_346928288_CV.descr
WHERE
	sdata_specimen.specimen_processing_term IS NULL AND
	sdata_specimen.specimen_processing = anon_346928288_CVkeys.cvkey
	AND anon_346928288_CVkeys.idkey = anon_346928288_CV.idkey
;
ALTER TABLE sdata_specimen ADD COLUMN specimen_storage_term VARCHAR(1024);

UPDATE sdata_specimen , anon_346968656_CVkeys , anon_346968656_CV
SET
	sdata_specimen.specimen_storage_term = anon_346968656_CV.descr
WHERE
	sdata_specimen.specimen_storage_term IS NULL AND
	sdata_specimen.specimen_storage = anon_346968656_CVkeys.cvkey
	AND anon_346968656_CVkeys.idkey = anon_346968656_CV.idkey
;
...
UPDATE sdata_sample , anon_346982600_CVkeys , anon_346982600_CV
SET
	sdata_sample.analyzed_sample_type_term = anon_346982600_CV.descr
WHERE
	sdata_sample.analyzed_sample_type_term IS NULL AND
	sdata_sample.analyzed_sample_type = anon_346982600_CVkeys.cvkey
	AND anon_346982600_CVkeys.idkey = anon_346982600_CV.idkey
;
...
UPDATE exp_m , anon_50310656_CVkeys , anon_50310656_CV
SET
	exp_m.data_status_term = anon_50310656_CV.descr
WHERE
	exp_m.data_status_term IS NULL AND
	exp_m.data_status = anon_50310656_CVkeys.cvkey
	AND anon_50310656_CVkeys.idkey = anon_50310656_CV.idkey
;
ALTER TABLE jcn_m ADD COLUMN data_status_term VARCHAR(1024);

UPDATE jcn_m , anon_50310656_CVkeys , anon_50310656_CV
SET
	jcn_m.data_status_term = anon_50310656_CV.descr
WHERE
	jcn_m.data_status_term IS NULL AND
	jcn_m.data_status = anon_50310656_CVkeys.cvkey
	AND anon_50310656_CVkeys.idkey = anon_50310656_CV.idkey
;
ALTER TABLE pdna_m ADD COLUMN data_status_term VARCHAR(1024);

UPDATE pdna_m , anon_50310656_CVkeys , anon_50310656_CV
SET
	pdna_m.data_status_term = anon_50310656_CV.descr
WHERE
	pdna_m.data_status_term IS NULL AND
	pdna_m.data_status = anon_50310656_CVkeys.cvkey
	AND anon_50310656_CVkeys.idkey = anon_50310656_CV.idkey
;
ALTER TABLE rreg_m ADD COLUMN data_status_term VARCHAR(1024);

UPDATE rreg_m , anon_50310656_CVkeys , anon_50310656_CV
SET
	rreg_m.data_status_term = anon_50310656_CV.descr
WHERE
	rreg_m.data_status_term IS NULL AND
	rreg_m.data_status = anon_50310656_CVkeys.cvkey
	AND anon_50310656_CVkeys.idkey = anon_50310656_CV.idkey
;
ALTER TABLE dlat_m ADD COLUMN data_status_term VARCHAR(1024);

UPDATE dlat_m , anon_50310656_CVkeys , anon_50310656_CV
SET
	dlat_m.data_status_term = anon_50310656_CV.descr
WHERE
	dlat_m.data_status_term IS NULL AND
	dlat_m.data_status = anon_50310656_CVkeys.cvkey
	AND anon_50310656_CVkeys.idkey = anon_50310656_CV.idkey
;
ALTER TABLE dlat_dm ADD COLUMN data_status_term VARCHAR(1024);

UPDATE dlat_dm , anon_50310656_CVkeys , anon_50310656_CV
SET
	dlat_dm.data_status_term = anon_50310656_CV.descr
WHERE
	dlat_dm.data_status_term IS NULL AND
	dlat_dm.data_status = anon_50310656_CVkeys.cvkey
	AND anon_50310656_CVkeys.idkey = anon_50310656_CV.idkey
;
...
UPDATE dlat_m , anon_347065544_CVkeys , anon_347065544_CV
SET
	dlat_m.mr_type_term = anon_347065544_CV.descr
WHERE
	dlat_m.mr_type_term IS NULL AND
	dlat_m.mr_type = anon_347065544_CVkeys.cvkey
	AND anon_347065544_CVkeys.idkey = anon_347065544_CV.idkey
;
ALTER TABLE dlat_n ADD COLUMN d_lation_type_term VARCHAR(1024);

UPDATE dlat_n , anon_347444744_CVkeys , anon_347444744_CV
SET
	dlat_n.d_lation_type_term = anon_347444744_CV.descr
WHERE
	dlat_n.d_lation_type_term IS NULL AND
	dlat_n.d_lation_type = anon_347444744_CVkeys.cvkey
	AND anon_347444744_CVkeys.idkey = anon_347444744_CV.idkey
;
ALTER TABLE dlat_dmr ADD COLUMN hyper_role_term VARCHAR(1024);

UPDATE dlat_dmr , anon_347460392_CVkeys , anon_347460392_CV
SET
	dlat_dmr.hyper_role_term = anon_347460392_CV.descr
WHERE
	dlat_dmr.hyper_role_term IS NULL AND
	dlat_dmr.hyper_role = anon_347460392_CVkeys.cvkey
	AND anon_347460392_CVkeys.idkey = anon_347460392_CV.idkey
;
