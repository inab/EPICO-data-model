-- File BLUEPRINT-data_model-0.3.1.0-20140218_CVtrans.sql
-- Generated from BLUEPRINT 0.3.1.0
-- Tue Feb 18 13:23:14 2014
...
UPDATE sdata_specimen , BrendaTissueOntology_CVkeys , BrendaTissueOntology_CV
SET
	sdata_specimen.specimen_term_term = BrendaTissueOntology_CV.descr
WHERE
	sdata_specimen.specimen_term_term IS NULL AND
	sdata_specimen.specimen_term = BrendaTissueOntology_CVkeys.cvkey
	AND BrendaTissueOntology_CVkeys.idkey = BrendaTissueOntology_CV.idkey
;
...
SET
	sdata_specimen.specimen_processing_term = _anonCV_0_CV.descr
WHERE
	sdata_specimen.specimen_processing_term IS NULL AND
	sdata_specimen.specimen_processing = _anonCV_0_CVkeys.cvkey
...
SET
	sdata_specimen.specimen_storage_term = _anonCV_1_CV.descr
WHERE
	sdata_specimen.specimen_storage_term IS NULL AND
	sdata_specimen.specimen_storage = _anonCV_1_CVkeys.cvkey
...
UPDATE sdata_sample , _anonCV_2_CVkeys , _anonCV_2_CV
SET
	sdata_sample.analyzed_sample_type_term = _anonCV_2_CV.descr
WHERE
	sdata_sample.analyzed_sample_type_term IS NULL AND
	sdata_sample.analyzed_sample_type = _anonCV_2_CVkeys.cvkey
...
UPDATE exp_m , _anonCV_3_CVkeys , _anonCV_3_CV
SET
	exp_m.data_status_term = _anonCV_3_CV.descr
WHERE
	exp_m.data_status_term IS NULL AND
	exp_m.data_status = _anonCV_3_CVkeys.cvkey
	AND _anonCV_3_CVkeys.idkey = _anonCV_3_CV.idkey
;
ALTER TABLE jcn_m ADD COLUMN data_status_term VARCHAR(1024);

UPDATE jcn_m , _anonCV_3_CVkeys , _anonCV_3_CV
SET
	jcn_m.data_status_term = _anonCV_3_CV.descr
WHERE
	jcn_m.data_status_term IS NULL AND
	jcn_m.data_status = _anonCV_3_CVkeys.cvkey
	AND _anonCV_3_CVkeys.idkey = _anonCV_3_CV.idkey
;
ALTER TABLE pdna_m ADD COLUMN data_status_term VARCHAR(1024);

UPDATE pdna_m , _anonCV_3_CVkeys , _anonCV_3_CV
SET
	pdna_m.data_status_term = _anonCV_3_CV.descr
WHERE
	pdna_m.data_status_term IS NULL AND
	pdna_m.data_status = _anonCV_3_CVkeys.cvkey
	AND _anonCV_3_CVkeys.idkey = _anonCV_3_CV.idkey
;
ALTER TABLE rreg_m ADD COLUMN data_status_term VARCHAR(1024);

UPDATE rreg_m , _anonCV_3_CVkeys , _anonCV_3_CV
SET
	rreg_m.data_status_term = _anonCV_3_CV.descr
WHERE
	rreg_m.data_status_term IS NULL AND
	rreg_m.data_status = _anonCV_3_CVkeys.cvkey
	AND _anonCV_3_CVkeys.idkey = _anonCV_3_CV.idkey
;
ALTER TABLE dlat_m ADD COLUMN data_status_term VARCHAR(1024);

UPDATE dlat_m , _anonCV_3_CVkeys , _anonCV_3_CV
SET
	dlat_m.data_status_term = _anonCV_3_CV.descr
WHERE
	dlat_m.data_status_term IS NULL AND
	dlat_m.data_status = _anonCV_3_CVkeys.cvkey
	AND _anonCV_3_CVkeys.idkey = _anonCV_3_CV.idkey
;
ALTER TABLE dlat_dm ADD COLUMN data_status_term VARCHAR(1024);

UPDATE dlat_dm , _anonCV_3_CVkeys , _anonCV_3_CV
SET
	dlat_dm.data_status_term = _anonCV_3_CV.descr
WHERE
	dlat_dm.data_status_term IS NULL AND
	dlat_dm.data_status = _anonCV_3_CVkeys.cvkey
	AND _anonCV_3_CVkeys.idkey = _anonCV_3_CV.idkey
;
...
SET
	dlat_m.mr_type_term = _anonCV_4_CV.descr
WHERE
	dlat_m.mr_type_term IS NULL AND
	dlat_m.mr_type = _anonCV_4_CVkeys.cvkey
	AND _anonCV_4_CVkeys.idkey = _anonCV_4_CV.idkey
;
ALTER TABLE dlat_n ADD COLUMN d_lation_type_term VARCHAR(1024);

UPDATE dlat_n , _anonCV_5_CVkeys , _anonCV_5_CV
SET
	dlat_n.d_lation_type_term = _anonCV_5_CV.descr
WHERE
	dlat_n.d_lation_type_term IS NULL AND
	dlat_n.d_lation_type = _anonCV_5_CVkeys.cvkey
	AND _anonCV_5_CVkeys.idkey = _anonCV_5_CV.idkey
;
ALTER TABLE dlat_dmr ADD COLUMN hyper_role_term VARCHAR(1024);

UPDATE dlat_dmr , _anonCV_6_CVkeys , _anonCV_6_CV
SET
	dlat_dmr.hyper_role_term = _anonCV_6_CV.descr
WHERE
	dlat_dmr.hyper_role_term IS NULL AND
	dlat_dmr.hyper_role = _anonCV_6_CVkeys.cvkey
