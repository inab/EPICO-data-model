-- File BLUEPRINT-data_model-0.3.2-20140806_CVtrans-mysql.sql (mysql dialect)
-- Generated from BLUEPRINT 0.3.2
-- Wed Aug  6 21:43:55 2014
...
SET
	sdata_specimen.specimen_processing_term = _anonCV_2_CV.descr
WHERE
	sdata_specimen.specimen_processing_term IS NULL AND
	sdata_specimen.specimen_processing = _anonCV_2_CVkeys.cvkey
...
SET
	sdata_specimen.specimen_storage_term = _anonCV_3_CV.descr
WHERE
	sdata_specimen.specimen_storage_term IS NULL AND
	sdata_specimen.specimen_storage = _anonCV_3_CVkeys.cvkey
...
UPDATE sdata_sample , _anonCV_4_CVkeys , _anonCV_4_CV
SET
	sdata_sample.analyzed_sample_type_term = _anonCV_4_CV.descr
WHERE
	sdata_sample.analyzed_sample_type_term IS NULL AND
	sdata_sample.analyzed_sample_type = _anonCV_4_CVkeys.cvkey
...
UPDATE lab_chro_features , _anonCV_5_CVkeys , _anonCV_5_CV
SET
	lab_chro_features.feature_term = _anonCV_5_CV.descr
WHERE
	lab_chro_features.feature_term IS NULL AND
	lab_chro_features.feature = _anonCV_5_CVkeys.cvkey
...
UPDATE dlat_m , _anonCV_6_CVkeys , _anonCV_6_CV
SET
	dlat_m.mr_type_term = _anonCV_6_CV.descr
WHERE
	dlat_m.mr_type_term IS NULL AND
	dlat_m.mr_type = _anonCV_6_CVkeys.cvkey
	AND _anonCV_6_CVkeys.idkey = _anonCV_6_CV.idkey
;
ALTER TABLE dlat_n ADD COLUMN d_lation_type_term VARCHAR(1024);

UPDATE dlat_n , _anonCV_7_CVkeys , _anonCV_7_CV
SET
	dlat_n.d_lation_type_term = _anonCV_7_CV.descr
WHERE
	dlat_n.d_lation_type_term IS NULL AND
	dlat_n.d_lation_type = _anonCV_7_CVkeys.cvkey
	AND _anonCV_7_CVkeys.idkey = _anonCV_7_CV.idkey
;
ALTER TABLE dlat_dmr ADD COLUMN hyper_role_term VARCHAR(1024);

UPDATE dlat_dmr , _anonCV_8_CVkeys , _anonCV_8_CV
SET
	dlat_dmr.hyper_role_term = _anonCV_8_CV.descr
WHERE
	dlat_dmr.hyper_role_term IS NULL AND
	dlat_dmr.hyper_role = _anonCV_8_CVkeys.cvkey
