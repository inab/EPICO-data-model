-- Generated from BLUEPRINT 0.2.3.98
-- Tue May 21 18:28:40 2013
...
-- Expression - Metadata File foreign keys
...
-- Exon Junction - Metadata File foreign keys
...
-- Protein-DNA interactions - Metadata File foreign keys
ALTER TABLE pdna_m ADD FOREIGN KEY (analyzed_sample_id,control_sample_id)
REFERENCES sdata_sample(sample_id,sample_id);

-- Protein-DNA interactions - Primary Analysis File foreign keys
ALTER TABLE pdna_p ADD FOREIGN KEY (analysis_id)
REFERENCES pdna_m(analysis_id);

-- Protein-DNA interactions - Secondary Analysis File foreign keys
...
-- Regulatory regions - Metadata File foreign keys
ALTER TABLE rreg_m ADD FOREIGN KEY (analyzed_sample_id,control_sample_id)
REFERENCES sdata_sample(sample_id,sample_id);
...
-- DNA *-lation - Metadata File foreign keys
ALTER TABLE dlat_m ADD FOREIGN KEY (analyzed_sample_id,control_sample_id)
REFERENCES sdata_sample(sample_id,sample_id);

-- DNA *-lation - Single Nucleotide File foreign keys
ALTER TABLE dlat_n ADD FOREIGN KEY (analysis_id)
REFERENCES dlat_m(analysis_id);

-- DNA *-lation - Methylated Region (CpGs, HMR) File foreign keys
ALTER TABLE dlat_mr ADD FOREIGN KEY (analysis_id)
REFERENCES dlat_m(analysis_id);

-- DNA *-lation - Annotation File foreign keys
