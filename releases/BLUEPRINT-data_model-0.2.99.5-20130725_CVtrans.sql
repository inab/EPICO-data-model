-- File BLUEPRINT-data_model-0.2.99.5-20130725_CVtrans.sql
-- Generated from BLUEPRINT 0.2.99.5
-- Thu Jul 25 21:37:01 2013
...
UPDATE sdata_specimen , anon_346311936_CVkeys , anon_346311936_CV
SET
	sdata_specimen.specimen_type_term = anon_346311936_CV.descr
WHERE
	sdata_specimen.specimen_type_term IS NULL AND
	sdata_specimen.specimen_type = anon_346311936_CVkeys.cvkey
	AND anon_346311936_CVkeys.idkey = anon_346311936_CV.idkey
;
ALTER TABLE sdata_specimen ADD COLUMN specimen_processing_term VARCHAR(1024);

UPDATE sdata_specimen , anon_347004600_CVkeys , anon_347004600_CV
SET
	sdata_specimen.specimen_processing_term = anon_347004600_CV.descr
WHERE
	sdata_specimen.specimen_processing_term IS NULL AND
	sdata_specimen.specimen_processing = anon_347004600_CVkeys.cvkey
	AND anon_347004600_CVkeys.idkey = anon_347004600_CV.idkey
;
ALTER TABLE sdata_specimen ADD COLUMN specimen_storage_term VARCHAR(1024);

UPDATE sdata_specimen , anon_347031240_CVkeys , anon_347031240_CV
SET
	sdata_specimen.specimen_storage_term = anon_347031240_CV.descr
WHERE
	sdata_specimen.specimen_storage_term IS NULL AND
	sdata_specimen.specimen_storage = anon_347031240_CVkeys.cvkey
	AND anon_347031240_CVkeys.idkey = anon_347031240_CV.idkey
;
...
UPDATE sdata_sample , anon_347044920_CVkeys , anon_347044920_CV
SET
	sdata_sample.analyzed_sample_type_term = anon_347044920_CV.descr
WHERE
	sdata_sample.analyzed_sample_type_term IS NULL AND
	sdata_sample.analyzed_sample_type = anon_347044920_CVkeys.cvkey
	AND anon_347044920_CVkeys.idkey = anon_347044920_CV.idkey
;
...
UPDATE exp_m , anon_50825104_CVkeys , anon_50825104_CV
SET
	exp_m.data_status_term = anon_50825104_CV.descr
WHERE
	exp_m.data_status_term IS NULL AND
	exp_m.data_status = anon_50825104_CVkeys.cvkey
	AND anon_50825104_CVkeys.idkey = anon_50825104_CV.idkey
;
ALTER TABLE jcn_m ADD COLUMN data_status_term VARCHAR(1024);

UPDATE jcn_m , anon_50825104_CVkeys , anon_50825104_CV
SET
	jcn_m.data_status_term = anon_50825104_CV.descr
WHERE
	jcn_m.data_status_term IS NULL AND
	jcn_m.data_status = anon_50825104_CVkeys.cvkey
	AND anon_50825104_CVkeys.idkey = anon_50825104_CV.idkey
;
ALTER TABLE pdna_m ADD COLUMN data_status_term VARCHAR(1024);

UPDATE pdna_m , anon_50825104_CVkeys , anon_50825104_CV
SET
	pdna_m.data_status_term = anon_50825104_CV.descr
WHERE
	pdna_m.data_status_term IS NULL AND
	pdna_m.data_status = anon_50825104_CVkeys.cvkey
	AND anon_50825104_CVkeys.idkey = anon_50825104_CV.idkey
;
ALTER TABLE rreg_m ADD COLUMN data_status_term VARCHAR(1024);

UPDATE rreg_m , anon_50825104_CVkeys , anon_50825104_CV
SET
	rreg_m.data_status_term = anon_50825104_CV.descr
WHERE
	rreg_m.data_status_term IS NULL AND
	rreg_m.data_status = anon_50825104_CVkeys.cvkey
	AND anon_50825104_CVkeys.idkey = anon_50825104_CV.idkey
;
ALTER TABLE dlat_m ADD COLUMN data_status_term VARCHAR(1024);

UPDATE dlat_m , anon_50825104_CVkeys , anon_50825104_CV
SET
	dlat_m.data_status_term = anon_50825104_CV.descr
WHERE
	dlat_m.data_status_term IS NULL AND
	dlat_m.data_status = anon_50825104_CVkeys.cvkey
	AND anon_50825104_CVkeys.idkey = anon_50825104_CV.idkey
;
ALTER TABLE dlat_dm ADD COLUMN data_status_term VARCHAR(1024);

UPDATE dlat_dm , anon_50825104_CVkeys , anon_50825104_CV
SET
	dlat_dm.data_status_term = anon_50825104_CV.descr
WHERE
	dlat_dm.data_status_term IS NULL AND
	dlat_dm.data_status = anon_50825104_CVkeys.cvkey
	AND anon_50825104_CVkeys.idkey = anon_50825104_CV.idkey
;
...
UPDATE dlat_m , anon_347071392_CVkeys , anon_347071392_CV
SET
	dlat_m.mr_type_term = anon_347071392_CV.descr
WHERE
	dlat_m.mr_type_term IS NULL AND
	dlat_m.mr_type = anon_347071392_CVkeys.cvkey
	AND anon_347071392_CVkeys.idkey = anon_347071392_CV.idkey
;
ALTER TABLE dlat_n ADD COLUMN d_lation_type_term VARCHAR(1024);

UPDATE dlat_n , anon_347262312_CVkeys , anon_347262312_CV
SET
	dlat_n.d_lation_type_term = anon_347262312_CV.descr
WHERE
	dlat_n.d_lation_type_term IS NULL AND
	dlat_n.d_lation_type = anon_347262312_CVkeys.cvkey
	AND anon_347262312_CVkeys.idkey = anon_347262312_CV.idkey
;
ALTER TABLE dlat_dmr ADD COLUMN hyper_role_term VARCHAR(1024);

UPDATE dlat_dmr , anon_347277888_CVkeys , anon_347277888_CV
SET
	dlat_dmr.hyper_role_term = anon_347277888_CV.descr
WHERE
	dlat_dmr.hyper_role_term IS NULL AND
	dlat_dmr.hyper_role = anon_347277888_CVkeys.cvkey
	AND anon_347277888_CVkeys.idkey = anon_347277888_CV.idkey
;
